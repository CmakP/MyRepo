 ...
 * linked list because each node only has a single link to another node. To 
 * store a single linked list, you only need to store a reference or pointer 
 * to the first node in that list. The last node has a pointer to nothingness 
